...
public class Connection {
    ...
    /**
     * extended by sean
     * get Connection from DataSource or ConnectionPoolDataSource
     */
    private void createConnection(){
        try{
            if(this.getSql2o().getDataSource() == null && this.getSql2o().getPoolDataSource() == null)
            ...
            }else if(this.getSql2o().getPoolDataSource() != null) { //Get Connection Object from PooledConnection
                this.jdbcConnection = this.getSql2o().getPoolDataSource().getPooledConnection().getConnection();
            }
        }
        catch(Exception ex){

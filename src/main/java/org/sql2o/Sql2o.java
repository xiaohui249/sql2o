...
public class Sql2o {
    ...
    public Sql2o(ConnectionPoolDataSource poolDataSource) {
        this(poolDataSource, QuirksMode.None);
    }
    ...
    public Sql2o(DataSource dataSource, QuirksMode quirksMode){
        this(dataSource, null, quirksMode);
    }
     ...
     * @param quirksMode    @{link QuirksMode} allows sql2o to work around known quirks and issues in different JDBC drivers.
     */
    public Sql2o(ConnectionPoolDataSource poolDataSource, QuirksMode quirksMode){
        this(null, poolDataSource, quirksMode);
    }
     ...
     * @param quirksMode
     */
    private Sql2o(DataSource dataSource, ConnectionPoolDataSource poolDataSource, QuirksMode quirksMode) {
    ...
    /**
     * extended by sean
     * Gets the ConnectionPoolDataSource that Sql2o uses internally to acquire database connections.
     * @return  The ConnectionPoolDataSource instance
     */
     ...
     * @return  The {@link java.util.Map<String, String>} instance, which Sql2o internally uses to map column names with property
     * names.
     */
     ...
     * @param defaultColumnMappings     A {@link java.util.Map} instance Sql2o uses internally to map between column names and
     *                                  property names.
     */
